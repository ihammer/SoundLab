...
<div id="author" style="padding-top:10px;">
	<div class="author_n">
		...
		<br>
		<span class="name" style="color:#6b6b6b;font-size:14px;">&nbsp;<?php echo $works["data"]["type_name"];?></span>
	</div>
	<div class="author_pl">
...
<div id="author" style="position:absolute;bottom:10px;height:30px;padding-left:10px;width:100%;">
	<!-- <div class="author_n">
		<span><img width="40" height="40" src="<?php echo $works["data"]["user"]["avatar"];?>" /></span>
		<span class="name">&nbsp;<?php echo $works["data"]["user"]["username"];?></span>
	</div> -->
	<div class="author_pl" style="width:100%;">
		<span style="margin-left:8px;"><img width="21" height="21" src="/test/helen/3.png" /></span>
		<span class="num">&nbsp;<?php echo $works["data"]["play_count"];?></span>
		<span><img width="19" height="19" src="/test/helen/4.jpg" /></span>
		<span>&nbsp;<?php echo $comment["meta"]["count"];?></span>
		<?php if(!empty($works["data"]["price"])!=0){?>
		<span style="margin-right:8px;display:block;height:17px;border:2px solid #000;background:#000;padding:0px 5px;font-size:14px;line-height:16px;float:right;color:#fff;"><?php echo $works["data"]["price"];?><font style="font-size:10px;">元</font></span>
		<?php }?>
	</div>
</div>
<script>
