...
<div style="width:100%;margin:0 auto;text-align:center;margin-top:20px;">
	<form method="post" id="form" action="/helppost.php">
		<textarea placeholder="输入你的意见想法，Lab的科学怪人们一直在努力！" name="advice" id="advice"></textarea>
		<input type="text"  placeholder="输入你的微信或邮箱" name="contact" id="contact" value="" />
...
<script type="text/javascript">
	function submitform(){
		var a = $('#advice').val();
		var c = $('#contact').val();
		$.post('/helppost.php',{advice:a,contact:c},function(msg){
				// alert(msg);
				if(msg==1){
					alert("发送成功了！");
				}else{
