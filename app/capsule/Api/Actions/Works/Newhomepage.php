    ...
    */   
     $start = ($page-1)*10;
            ...
            if(!empty($aid)){
                ...
                $works = $this->work->with('author')->whereIn('id',$workIds)->where('top_sort','<>',0)->skip($start)->take(10)->orderBy('play_count','desc')->get();
             ...
             //最热筛选  本周最热
                ...
                //最新
                //这个条件有问题
                $where_new = array('deleted_at' => null, 'is_private' => 0);
				$works = $this->work->with('author')->where($where_new)->skip($start)->take(10)->orderBy('modified','desc')->get();
            }
