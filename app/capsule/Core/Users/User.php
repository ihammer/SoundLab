...
use Carbon\Carbon;
use Capsule\Core\Users\Events\UserUsernameWasChanged;
use Capsule\Core\Users\Events\UserMobileWasChanged;
use Capsule\Core\Users\Events\UserPasswordWasChanged;
use Capsule\Core\Users\Events\UserAvatarWasChanged;
...
class User extends UserModel {
	...
	{
		return $this->hasMany('Capsule\Core\Works\Work', 'user_id');
	}
	// 用户的专辑列表
	public function albums()
	{
		return $this->hasMany('Capsule\Core\Albums\Album', 'user_id');
	}
	// 用户喜欢过的歌曲
	public function likes()
	{
		return $this->belongsToMany('Capsule\Core\Works\Work', 'users_likes', 'user_id', 'work_id')->withTimestamps();
	}
	// feeds
	public function feeds()
	{
		return $this->hasMany('Capsule\Core\Feed', 'user_id');
	}
	//用户创建的标签 
	public function tags()
	{
		return $this->hasMany('Capsule\Core\Tags\Tag');
	}
	// 用户关注的标签
	public function followingTags()
	{
		return $this->belongsToMany('Capsule\Core\Tags\Tag', 'users_tags', 'tag_id', 'user_id');
	}
	// 我关注的用户
	public function following()
	{
		return $this->belongsToMany('Capsule\Core\Users\User', 'users_following', 'fromuid', 'touid');
	}
	// 我的粉丝
	public function follower()
	{
		return $this->belongsToMany('Capsule\Core\Users\User', 'users_follower', 'fromuid', 'touid');
	}
	// 第三方账号token
	public function tokens()
	{
		return $this->hasMany('Capsule\Core\Users\Token');
	}
