...
use Record\Api\Serializers\UserBasicSerializer;
use Record\Core\Users\Commands\RegisterUserCommand;
...
class Register extends Base {
	...
	public function run()
	{
		...
		try {
			...
			if ( !$user ) 
			{
				return $this->respondWithError('registerFailed');
			}
			...
			//DB::update("UPDATE users SET uuid = '".$res["entities"][0]["uuid"]."' WHERE id = ".$user->getId());
