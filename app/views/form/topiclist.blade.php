...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  ...
  <div id="content-header">
    <div id="breadcrumb"> <a href="admin" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">专题</a> </div>
    <h1> 专题带“<?php echo $tag->name;?>”的作品 </h1>
  </div>
			  ...
			  ?>
                <tr>
				  ...
				  <td style="text-align:center;">
				  	...
				  	<?php if($items->is_compshow==1){echo "<span onclick='Javascript:compaignBut.call(this);' workid='".$items->id."' style='cursor:pointer;'>活动推荐(OUT)</span>";}else{echo "<span onclick='Javascript:compaignBut.call(this);' workid='".$items->id."' style='cursor:pointer;'>活动推荐(IN)</span>";}?>&nbsp;&nbsp;<span onclick='Javascript:tagBut.call(this);' workid='<?php echo $items->id;?>' style='cursor:pointer;'>编辑标签</span>
