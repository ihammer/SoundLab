...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
	<ul>
		<li class="active submenu open"><a href="/123xxxadmin/admin"><i class="icon icon-home"></i> <span>首页</span></a> </li>
  ...
  <div id="content-header">
    <div id="breadcrumb"> <a href="/123xxxadmin/admin" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">用户意见</a> </div>
    <h1>用户意见</h1>
  </div>
    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="widget-content nopadding">
          <form action="/123xxxadmin/helps/upsave" method="post" class="form-horizontal">
          	<input type="hidden" name="id" value="<?php echo $model->id;?>">
            <div class="control-group">
              <label class="control-label">用户联系方式 :</label>
              <div class="controls">
                <input type="text" name="contact"  class="span11" readonly="readonly" value="<?php echo $model->contact;?>"  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">意见 :</label>
              <div class="controls">
                <textarea class="span11" style="height:100px;" readonly="readonly" name="info"><?php echo $model->info;?></textarea>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">状态 :</label>
              <div class="controls">
				<input id="compshowno" name="status" type="radio" value="0" <?php echo $model->status==0?'checked="checked"':'';?>>未确认
				<input id="compshowyes" name="status" type="radio" value="1" <?php echo $model->status==1?'checked="checked"':'';?>>已确认
				<span class="help-block"></span>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">意见解答 :</label>
              <div class="controls">
                <textarea class="span11" style="height:100px;" name="callinfo"><?php echo $model->callinfo;?></textarea>
              </div>
            </div>
