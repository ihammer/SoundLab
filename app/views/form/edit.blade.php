    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="widget-content nopadding">
          <form action="/123xxxadmin/upsave" method="post" class="form-horizontal">
          	<input type="hidden" value="<?php echo $_GET['upuser'];?>" name="upuser" >
          	<input type="hidden" value="<?php echo $_GET['typesid'];?>" name="typesid" >
          	<input type="hidden" name="id" value="<?php echo $model->id;?>">
            <div class="control-group">
              <label class="control-label">用户名 :</label>
              <div class="controls">
                <input type="text" name="username" class="span11" value="<?php echo $model->username;?>"  />
              </div>
            </div>
            <?php
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="mobile" class="span11" value="<?php echo $model->mobile;?>" />
              </div>
            </div>
            <?php
	            }
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="city" value="<?php echo $ca[0];?>" /> <input type="text" name="area" value="<?php echo $ca[1];?>" />
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                <select name="sex">
					<option value="1"<?php echo $model->sex==1 ? " selected='selected'" : " ";?>>男</option>
					<option value="2"<?php echo $model->sex==2 ? " selected='selected'" : " ";?>>女</option>
					<option value="0"<?php echo $model->sex==0 ? " selected='selected'" : " ";?>>外星人</option>
				</select>
              </div>
            </div>
            <div class="control-group">
				  ...
				  <div class="controls">
					  <select name="utype_id">
						  <option value="0"<?php echo $model->utype_id==0 ? " selected=selected" : "";?>>暂无分类</option>
						  <?php
						  foreach($types as $key=>$val){
							  if($model->utype_id==$val->id){
            ...
            <div class="control-group">
              ...
              <div class="controls">
            <div class="btn"> <span>更新头像</span>
              <input id="fileupload" type="file" name="avatar">
            </div>
            <input type="button" id="saveimg" value="确认保存" class="Intercbtn" />
            <a href='http://7xikb7.com1.z0.glb.clouddn.com/<?php echo $model->avatar;?>' target="blank"><font color='green'><?php echo $model->avatar;?></font></a>
            <div class="progress"> <span class="bar"></span><span class="percent">0%</span > </div>
            <div class="files"></div>
            <div id="showimg"><?php if(!empty($model->avatar)){?><img width="240" height="240" src="http://7xikb7.com1.z0.glb.clouddn.com/<?php echo $model->avatar;?>" /><?php }else{?><img src="/images/01.jpg" /><?php }?><!--初始图片--></div>
          </div>
          <input type="hidden" id="src" name="src" value="<?php echo $model->avatar;?>" />
          ...
          <input type="hidden" id="h" name="h" value="240" />
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <textarea class="span11" name="introduce"><?php echo $model->introduce;?></textarea>
							</div>
              </div>
