...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  ...
  <div class="container-fluid">
  	<span><a href="/123xxxadmin/opus/newlist">已上架</a></span>&nbsp;&nbsp;
  	<span><a href="/123xxxadmin/opus/newlist?verify=0">后台上传</a></span>&nbsp;&nbsp;
  	<span><a href="/123xxxadmin/opus/newlist?verify=2">已下架</a></span>
    <hr>
    <div class="row-fluid">
      <div class="span12">
            ...
            <table class="table table-bordered data-table">
			  ...
			  ?>
                <tr>
                  ...
                  <td><?php echo $items->is_private==0 ? "公开" : "私有";?></td>
                  <td><?php echo $items->created_at;?></td>
				  <td style="text-align:center;">
				  	<a href="/123xxxadmin/opus/<?php echo $items->id;?>/newverify">审核</a>
				  </td>
                </tr>
			  <?php
			  }
