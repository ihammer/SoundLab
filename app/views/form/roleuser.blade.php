...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  ...
  <div id="content-header">
    <div id="breadcrumb"> <a href="admin" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">管理员</a> </div>
    <h1>管理员</h1>
  </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
			  ...
			  ?>
                <tr>
                  <td><?php echo $items["attributes"]["adminname"];?></td>
                  <td><?php echo $items["attributes"]["roleid"]==1?'超级管理员':'小编';?></td>
                  <td><?php echo $items["attributes"]["created_at"];?></td>
				  <td style="text-align:center;"><!--a href="deluser?id=<?php echo $items["attributes"]["id"]; ?>">删除</a>&nbsp;&nbsp;&nbsp;&nbsp;--><?php if($items["attributes"]["id"]==1){?><?php }else{?><a href="roleuser/<?php echo $items["attributes"]["id"]; ?>/edit">编辑</a><?php }?></td>
                </tr>
			  <?php
			  }
			  ?>
