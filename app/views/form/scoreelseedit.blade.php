...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  ...
  <div id="content-header">
    <div id="breadcrumb"> <a href="/123xxxadmin/admin" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="/123xxxadmin/scoreelse" class="current">特殊积分</a> </div>
    <h1>特殊积分</h1>
  </div>
    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="widget-content nopadding">
          <form action="/123xxxadmin/upsavescoreelse" method="post" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <select name="status">
					...
					<?php }else{?>
					<option value="0"<?php echo $model->status==1 ? " selected='selected'" : " ";?>>审核通过</option>
					<option value="0"<?php echo $model->status==2 ? " selected='selected'" : " ";?>>驳回</option>
					<?php }?>
