...
<link href='http://fonts.useso.com/css?family=Open+Sans:400,700,800' rel='stylesheet' type='text/css'>
	...
	<script type="text/javascript">
		...
		function fill(thisValue,id,mobile) {
    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="widget-content nopadding">
          <form action="/123xxxadmin/upmedia" method="post" id="commentForm" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">作品名称 :</label>
              <div class="controls">
                <textarea name="title" id="title" class="span11" id="firstname" placeholder="请输入作品名称"></textarea>
                <span id="titleb" style="display:none;"><font color="red">＊必填</font></span>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
				...
				<span id="playurlb" style="display:none;"><font color="red">＊必填</font></span>
				<input type="hidden" id="playurl" name="playurl" value="" />
            ...
            <div class="control-group">
              ...
              <div class="controls">
					  ...
					  <div>
						  <input type="text" class="input-text" size="30" value="" id="inputString" name="username" onkeyup="lookup(this.value);" onblur="fill(thisValue,id);" /><span id="useridb" style="display:none;"><font color="red">＊必填</font></span>
					  </div>
				  ...
				  <input type="text" id="user_mobile" value="" readonly="readonly" style="border:none;background:#f9f9f9;">
            ...
            <div class="control-group">
              ...
              <div class="controls">
              	<input id="tl" type="input" name="tl"> 秒<span id="addimageb" style="display:none;"><font color="red">＊必填</font></span>
            ...
            <div class="control-group">
              ...
              <div class="controls">
				<input id="dmshowno" name="is_dmshow" type="radio" value="0" checked="checked">否
				<input id="dmshowyes" name="is_dmshow" type="radio" value="1">是
            ...
            <div class="control-group">
              <label class="control-label">是否最新显示 :</label>
              <div class="controls">
				<input id="isverifyno" name="is_verify" type="radio" value="0" checked="checked">否
				<input id="isverifyyes" name="is_verify" type="radio" value="1">是
				<span class="help-block"></span>
              </div>
            </div>
            <div class="form-actions">
              <button type="button" onclick="subform()" class="btn btn-success">添加作品</button>
            </div>
          </form>
        </div>
      </div>
...
function subform(){
	...
	if($.trim($("#title").val()).length == 0){
		...
		if($.trim($("#user_id").val()).length == 0){
			...
			useridcheck = true;
			$("#useridb").hide();
			if($.trim($("#addimage").html()).length == 0){
				$("#tl").focus();
				$("#addimageb").show();
			}else{
				addimagecheck = true;
				$("#addimageb").hide();
				if($.trim($("#playurl").val()).length == 0){
					$("#mediaupload").focus();
					$("#playurlb").show();
				}else{
					playurlcheck = true;
