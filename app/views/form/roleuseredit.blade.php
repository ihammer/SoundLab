    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="widget-content nopadding">
          <form action="/123xxxadmin/roleuser/upsave" method="post" class="form-horizontal">
          	<input type="hidden" name="id" value="<?php echo $model->id;?>">
          	<input type="hidden" name="roleid" value="<?php echo $model->roleid;?>">
            <div class="control-group">
              <label class="control-label">用户名 :</label>
              <div class="controls">
                <input type="text" name="adminname" onKeyUp="value=value.replace(/[^a-zA-Z]/g,'')" class="span11" value="<?php echo $model->adminname;?>"  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">密码 :</label>
              <div class="controls">
                <input type="password" name="adminpassword" class="span11" value="" />
              </div>
            </div>
