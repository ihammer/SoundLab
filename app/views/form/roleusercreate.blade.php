...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  ...
  <div id="content-header">
    <div id="breadcrumb"> <a href="/123xxxadmin/admin" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">管理员</a> </div>
    <h1>管理员</h1>
  </div>
    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="widget-content nopadding">
          <form action="/123xxxadmin/roleuser/saveuser" method="post" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">用户名 :</label>
              <div class="controls">
                <input type="text" name="adminname" onKeyUp="value=value.replace(/[^a-zA-Z]/g,'')"   class="span11" placeholder="请输入用户名" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">密码 :</label>
              <div class="controls">
                <input type="password" name="adminpassword"  class="span11" placeholder="请输入密码" />
              </div>
            </div>
