...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  ...
  <div id="content-header">
    <div id="breadcrumb"> <a href="admin" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">特殊积分</a> </div>
    <h1>特殊积分</h1>
  </div>
      ...
      <div class="span12">
        ...
        ?>
                <tr>
                  ...
                  <td>
                  <?php echo $items["attributes"]["type"]==1?"加":'';?>
                  <?php echo $items["attributes"]["type"]==2?"减":'';?>
                  <?php echo $items["attributes"]["num"];?></td>
                  <td>
                  <?php echo $items["attributes"]["status"]==0?'未处理':'';?>
                  <?php echo $items["attributes"]["status"]==1?'<font color="green">已审核</font>':'';?>
                  <?php echo $items["attributes"]["status"]==2?'<font color="red">驳回</font>':'';?>
                  </td>
                  <td><?php echo $items["attributes"]["reason"];?></td>
                  <td><?php echo $items["attributes"]["created_at"];?></td>
                  <td style="text-align:center;">
                    <?php if($items["attributes"]["id"]==1){?><?php }else{?><a href="scoreelse/<?php echo $items["attributes"]["id"]; ?>/edit">编辑</a><?php }?>
                  </td>
                </tr>
        <?php
        }
